        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisputeLostCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicEvidenceUrl = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayoutInfo = table.Column<string>(type: "text", nullable: true),
                    AdminEvidence = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResolvedTransactionId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlockedPayouts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlockedPayouts_Transactions_ResolvedTransactionId",
                        column: x => x.ResolvedTransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlockedPayouts_Users_OriginalUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlockedPayouts_OriginalUserId",
                table: "BlockedPayouts",
                column: "OriginalUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BlockedPayouts_ResolvedTransactionId",
                table: "BlockedPayouts",
